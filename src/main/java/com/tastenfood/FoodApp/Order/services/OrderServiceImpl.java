...
import com.tastenfood.FoodApp.Order.repository.OrderItemRepository;
import com.tastenfood.FoodApp.Order.repository.OrderRepository;
...
public class OrderServiceImpl  implements OrderService{
    ...
    private void sendOrderConfirmationEmail(User customer, OrderDTO orderDTO){
        ...
        notificationService.sendmail(NotificationDTO.builder()
